...
public class Main {
	...
	private static final IViewNavigationHandler viewNavigationHandler = new ViewNavigationHandler(viewFactory, resourceRepository);

	public static void main(String[] args) {
		logger.info("Application started");
		new MainWindow(viewNavigationHandler, resourceRepository);
	}
}
